...
import card02 from "./Card.module.css";
...
const Card2 = () => {
  return (
    <div>
      <Swiper spaceBetween={150} slidesPerView={2} className={card02.slide2}>
        <SwiperSlide>
          <div className={card02.card}>
            <img src={card1} alt="" />
            <p>fullstack</p>
            <h4>amazon clone</h4>
            <a
              ...
              rel="noreferrer"
            >
              view project <ArrowForward className={card02.arrow} />
            </a>
          </div>
        </SwiperSlide>
        <SwiperSlide>
