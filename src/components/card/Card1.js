...
import card01 from "./Card.module.css";
...
const Card1 = () => {
  return (
    <div>
      <Swiper spaceBetween={120} slidesPerView={2} className={card01.slide1}>
        <SwiperSlide>
          <div className={card01.card}>
            <img src={card1} alt="" />
            <p>fullstack</p>
            <h4>amazon clone</h4>
            <a
              ...
              rel="noreferrer"
            >
              view project <ArrowForward className={card01.arrow} />
            </a>
          </div>
        </SwiperSlide>
        <SwiperSlide>
